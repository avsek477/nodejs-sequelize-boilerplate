((securityConfigure) => {
  ...
  // max file size 1MB
  const MAX_CONTENT_LENGTH_ACCEPTED = 1000000;
    ...
    app.use(helmet.contentSecurityPolicy({
      ...
      directives: {
        ...
        scriptSrc: [
          ...
          'apis.google.com/', 'www.google-analytics.com', 'ajax.googleapis.com', 'maps.googleapis.com/',
          'embed.js/', 'demo-nodebeats-com.disqus.com/', 'a.disquscdn.com/'],
        styleSrc: ['\'self\'', '\'unsafe-inline\'', 'fonts.googleapis.com/', 'a.disquscdn.com/'],
        imgSrc: [
          '\'self\' data:', 'stats.g.doubleclick.net/', 'www.google-analytics.com/', 'res.cloudinary.com/',
          'csi.gstatic.com/', 'maps.gstatic.com/', 'maps.googleapis.com/', 'referrer.disqus.com/', 'a.disquscdn.com/'],
